...
function StudentPricingPage() {
  ...
  const tiers = [
    {
      ...
      desc: "Zero financial barrier. Start learning immediately.",
      color: "var(--text2)", cta: "Get Started Free", ctaC: "ghost",
  ...
  return (
    <div className="page-enter" style={{ paddingTop: 16 }}>
      <section style={{ padding: "1.5rem 0 1rem", textAlign: "center" }}>
        <ScrollReveal>
          <div>
            <div className="tag" style={{ display: "inline-flex" }}>Pricing</div>
            <h1 className="st" style={{ margin: "0 auto" }}>Student plans.<br /><em>Maximum impact.</em></h1>
        ...
        <StaggerContainer className="g2" style={{ gap: "1.2rem", alignItems: "start", maxWidth: 760, margin: "0 auto" }}>
          {tiers.map((t, i) => (
      ...
      <section style={{ padding: "3rem 0 2rem", maxWidth: 760, margin: "0 auto" }}>
        <ScrollReveal>
